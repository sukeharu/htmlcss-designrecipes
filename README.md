...
なお、公式配布版のサンプルデータは下記技術評論社のWebサイトからダウンロードできます。

## 本書の特徴
本書は、よく使う基本のマークアップから、実践的なレイアウト（`float`/`flexbox`）、アニメーション（`@keyframe`）まで、Webデザインに効く実用的なテクニックを満載した、HTML&CSSの逆引きリファレンスです。「こういうことがしたい」と思ったとき、パッと引けてすぐに役立ちます。
